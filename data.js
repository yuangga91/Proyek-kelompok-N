...
const recipesDatabase = [
    ...
    },
    {
        ...
        fat: 18,
        fiber: 2,
        ingredients: ["2 butir telur", "75g tepung terigu", "1 piring nasi putih", "saus sambal", "garam", "minyak goreng"],
        steps: ["Campur telur dan tepung", "Goreng telur crispy", "Sajikan di atas nasi dengan saus sambal"],
        allergens: ["egg", "gluten"],
        type: "healthy"
    },
    {
        ...
        fat: 28,
        fiber: 1,
        ingredients: ["150g ayam", "5 siung bawang merah", "5 cabai rawit", "2 sdm minyak kelapa", "garam", "gula"],
        steps: ["Goreng ayam hingga matang", "Tumis sambal matah ringan", "Sajikan ayam dengan sambal matah"],
        allergens: [],
        type: "healthy"
    },
    {
        ...
        fat: 18,
        fiber: 3,
        ingredients: ["1 porsi mie", "50g sawi", "1 butir telur", "3 siung bawang putih", "saus sambal"],
        steps: ["Rebus mie setengah matang", "Tambahkan sayur dan telur", "Tuangkan kuah lalu sajikan"],
    ...
    },
    {
        ...
        fat: 18,
        fiber: 3,
        ingredients: ["150g ayam", "2 sdm saus teriyaki", "1 piring nasi putih", "1 batang daun bawang"],
        steps: ["Tumis ayam dengan saus teriyaki", "Sajikan di atas nasi", "Taburi daun bawang"],
        allergens: ["soy"],
        type: "unhealthy"
    },
    {
        id: 20,
        name: "Seblak Mie Bakso",
        emoji: "🔥",
        category: "main",
        cost: 15000,
        calories: 600,
        ...
        fat: 24,
        fiber: 4,
        ingredients: ["50g kerupuk", "1 porsi mie", "5 bakso", "2 siung bawang putih", "sayuran"],
        steps: ["Rebus semua bahan pedas", "Tambahkan bumbu seblak", "Masak hingga matang"],
        allergens: ["gluten"],
        type: "unhealthy"
    },
    {
        ...
        fat: 22,
        fiber: 2,
        ingredients: ["1 piring nasi putih", "1 kaleng kornet", "1 butir telur", "2 siung bawang putih"],
        steps: ["Tumis bawang putih dan kornet", "Masukkan nasi dan telur", "Aduk rata hingga matang"],
        allergens: ["egg"],
        type: "unhealthy"
    },
    {
        ...
        fat: 10,
        fiber: 5,
        ingredients: ["1 ikat kangkung", "100g tempe", "3 siung bawang putih", "2 sdm kecap manis"],
        steps: ["Tumis bawang putih hingga harum", "Masukkan tempe dan kangkung", "Tambahkan bumbu lalu sajikan"],
        allergens: ["soy"],
        type: "healthy"
    },
    {
        ...
        fat: 12,
        fiber: 3,
        ingredients: ["200g ayam", "1 wortel", "1 kentang", "3 siung bawang putih", "air"],
        steps: ["Rebus ayam hingga empuk", "Tambahkan sayur", "Masak hingga matang"],
        allergens: [],
        type: "healthy"
    },
    {
        ...
        fat: 18,
        fiber: 2,
        ingredients: ["200g tahu", "3 siung bawang putih", "5 cabai", "garam", "minyak goreng"],
        steps: ["Goreng tahu hingga garing", "Tumis cabai bawang", "Campur tahu dengan bumbu"],
        allergens: ["soy"],
        type: "unhealthy"
    },
    {
        ...
        fat: 30,
        fiber: 2,
        ingredients: ["150g ayam fillet", "tepung roti", "1 porsi nasi putih", "minyak goreng"],
        steps: ["Baluri ayam dengan tepung roti", "Goreng hingga crispy", "Sajikan dengan nasi"],
        allergens: ["gluten", "egg"],
        type: "unhealthy"
    },
    {
        id: 26,
        name: "Pasta Aglio Olio Sosis",
        emoji: "🍝",
        category: "main",
        cost: 20000,
        calories: 550,
        ...
        fat: 22,
        fiber: 3,
        ingredients: ["100g spaghetti", "2 sosis", "3 siung bawang putih", "minyak zaitun"],
        steps: ["Rebus pasta hingga al dente", "Tumis bawang putih dan sosis", "Campur pasta dengan bumbu"],
        allergens: ["gluten"],
        type: "unhealthy"
    },
    {
        ...
        fat: 12,
        fiber: 6,
        ingredients: ["sayur rebus", "100g tempe", "2 sdm sambal kacang", "bawang goreng"],
        steps: ["Rebus semua sayuran", "Sajikan dengan tempe goreng", "Tuang sambal kacang"],
        allergens: ["peanut"],
        type: "healthy"
    },
    {
        ...
        fat: 22,
        fiber: 2,
        ingredients: ["2 potong roti", "2 butir telur", "2 sdm mayo", "selada"],
        steps: ["Rebus telur dan cincang", "Campur dengan mayo", "Susun di antara roti"],
        allergens: ["egg", "gluten"],
        type: "healthy"
    },
    {
        id: 29,
        name: "Oat Pisang Peanut Butter",
        emoji: "🥣",
        category: "breakfast",
        cost: 15000,
        calories: 380,
        ...
        fat: 15,
        fiber: 6,
        ingredients: ["50g oat", "1 pisang", "2 sdm selai kacang", "200ml air"],
        steps: ["Campur oat dan air lalu masak", "Tambahkan pisang dan selai kacang", "Aduk dan sajikan hangat"],
        allergens: ["peanut"],
        type: "healthy"
    },
    {
        ...
        fat: 24,
        fiber: 2,
        ingredients: ["150g ayam", "1 paprika", "1 sdt lada hitam", "2 siung bawang putih"],
        steps: ["Tumis ayam dan paprika", "Tambahkan lada hitam", "Masak hingga bumbu meresap"],
        allergens: [],
        type: "healthy"
    }
];
...
const foodMenusTembalang = [
    ...
    { id: 11, name: "Bakso Urat Jumbo", type: "Junk", price: 18000, calories: 550, nutrition: "Protein", allergens: ["gluten"], emoji: "🥟" },
    { id: 12, name: "Chicken Katsu", type: "Junk", price: 22000, calories: 720, nutrition: "Protein tinggi", allergens: ["gluten"], emoji: "🍗" },
    { id: 13, name: "Salad Sayur", type: "Sehat", price: 15000, calories: 180, nutrition: "Serat tinggi", allergens: [], emoji: "🥗" },
    { id: 14, name: "Sop Ayam", type: "Sehat", price: 16000, calories: 320, nutrition: "Protein rendah lemak", allergens: [], emoji: "🍲" },
    { id: 15, name: "Rice Bowl Salted Egg", type: "Junk", price: 24000, calories: 690, nutrition: "Protein", allergens: ["egg"], emoji: "🍚" },
    { id: 16, name: "Tahu Tempe Bacem", type: "Sehat", price: 10000, calories: 280, nutrition: "Protein nabati", allergens: ["soy"], emoji: "🟫" },
    { id: 17, name: "Nasi Bandeng", type: "Sehat", price: 18000, calories: 430, nutrition: "Omega-3", allergens: ["Ikan"], emoji: "🐟" },
    { id: 18, name: "Mie Bangladesh", type: "Junk", price: 17000, calories: 700, nutrition: "Karbo tinggi", allergens: ["gluten"], emoji: "🍜" },
    { id: 19, name: "Bubur Ayam", type: "Sehat", price: 12000, calories: 300, nutrition: "Protein ringan", allergens: ["gluten"], emoji: "🍲" },
    { id: 20, name: "Smoothie Pisang Oat", type: "Sehat", price: 18000, calories: 260, nutrition: "Serat", allergens: ["milk"], emoji: "🥤" }
];
...
const foodPlacesTembalang = [
    ...
    {
        id: 7,
        name: "Bintang Pagi Tembalang",
        emoji: "🌅",
        type: "Warung Mahasiswa",
        address: "Jl. Tembalang, Semarang",
        phone: "+6281234567890",
        avgPrice: 16000,
        hours: "Buka sampai dini hari",
        recommendations: ["Nasi ayam sambal"],
        nutrients: ["Protein tinggi"],
        allergies: ["egg"],
        rating: 4.4
    },
    {
        id: 8,
        name: "GEPREK SOHOR Banjarsari Tembalang",
        emoji: "🍗",
        type: "Ayam Geprek",
        address: "Jl. Banjarsari, Tembalang",
        phone: "+6281112223334",
        avgPrice: 20000,
        hours: "Dekat kos mahasiswa",
        recommendations: ["Ayam geprek mozzarella"],
        nutrients: ["Protein tinggi"],
    ...
    {
        id: 9,
        name: "Bakso Bang Udin",
        emoji: "🥟",
        type: "Bakso",
        address: "Jl. Tembalang, Semarang",
        phone: "+6281199988776",
        avgPrice: 15000,
        hours: "Ramai malam hari",
        recommendations: ["Bakso urat jumbo"],
        nutrients: ["Protein"],
        allergies: ["gluten"],
        rating: 4.4
    },
    {
        id: 10,
        name: "Mie Ayam Jakarta Bang Mail",
        emoji: "🍜",
        type: "Mie Ayam",
        address: "Jl. Tembalang, Semarang",
        phone: "+6281122233344",
        avgPrice: 14000,
        hours: "Dekat UNDIP",
        recommendations: ["Mie ayam pangsit"],
        nutrients: ["Karbo tinggi"],
        allergies: ["gluten"],
        rating: 4.3
    },
    {
        id: 11,
        name: "Penyet Kuah Timoho",
        emoji: "🍛",
        type: "Penyetan",
        address: "Jl. Timoho, Tembalang",
        phone: "+6281231231234",
        avgPrice: 18000,
        hours: "Favorit mahasiswa",
        recommendations: ["Ayam penyet kuah"],
        nutrients: ["Protein"],
        allergies: ["soy"],
        rating: 4.6
    },
    {
        ...
        avgPrice: 11500,
        hours: "24 jam",
        recommendations: ["Nasi telur sayur"],
        nutrients: ["Serat"],
        allergies: ["egg"],
        rating: 4.2
    },
    {
        id: 13,
        name: "Geprek Raja Tembalang",
        emoji: "👑",
        type: "Ayam Geprek",
        address: "Jl. Tembalang, Semarang",
        phone: "+6281444455566",
        avgPrice: 17000,
        hours: "Online tersedia",
        recommendations: ["Geprek level pedas"],
        nutrients: ["Protein"],
        allergies: ["gluten"],
        rating: 4.4
    },
    {
        id: 14,
        name: "Mie Ayam & Bakso Salatiga (Tembalang)",
        emoji: "🥣",
        type: "Bakso & Mie",
        address: "Jl. Tembalang, Semarang",
        phone: "+6281555566677",
        avgPrice: 16000,
        hours: "Dekat area kos",
        recommendations: ["Bakso campur"],
        nutrients: ["Protein"],
        allergies: ["gluten"],
        rating: 4.3
    },
    {
        id: 15,
        name: "Mie Bandung GG Belakang Pak Min Tembalang",
        emoji: "🥢",
        type: "Chinese Food",
        address: "Jl. Tembalang, Semarang",
        phone: "+6281666677788",
        avgPrice: 20000,
        hours: "Malam ramai",
        recommendations: ["Mie bandung seafood"],
        nutrients: ["Protein"],
        allergies: ["seafood"],
        rating: 4.4
    },
    {
        id: 16,
        name: "Sedap Malam (Warung Internet & Roti Bakar) Sumurboto Banyumanik",
        emoji: "🌙",
        type: "Nongkrong Mahasiswa",
        address: "Jl. Sumurboto, Banyumanik, Semarang",
        phone: "+6281777788899",
        avgPrice: 15000,
        hours: "Buka malam",
        recommendations: ["Roti bakar coklat"],
        nutrients: ["Karbo tinggi"],
        allergies: ["milk"],
        rating: 4.5
    },
    ...
    },
    {
        ...
        emoji: "🍗",
        type: "Fast Food Lokal",
        address: "Jl. Tembalang, Semarang",
        phone: "+6281999900112",
        avgPrice: 17500,
        hours: "Delivery tersedia",
        recommendations: ["Ayam geprek sambal bawang"],
        nutrients: ["Protein"],
        allergies: ["gluten"],
        rating: 4.5
    }
